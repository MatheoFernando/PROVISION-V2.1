...
export function AdminServicesTabs({
  ...
  return (
    <Tabs defaultValue="modules" className="space-y-4">
      <TabsList>
        <TabsTrigger value="modules" className="cursor-pointer">Serviços</TabsTrigger>
        <TabsTrigger value="company-modules" className="cursor-pointer">Serviços por empresa</TabsTrigger>
      </TabsList>
      ...
      <TabsContent value="company-modules" className="space-y-4">
        ...
        <ListServices services={companyModules} isLoading={isLoading} />
      </TabsContent>
